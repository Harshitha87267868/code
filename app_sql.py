...
final1= joblib.load('Final_Career_model.pkl') 
...
# Print the output. 
    ...
    if prediction == 0:
        pred = "Choose CSE,Mechtronics Engineering"
        
    elif prediction == 1: 
        pred = "Choose Chemial,Textile Engineering"
        
    elif prediction == 2:
        pred = "Choose Aeronotical,Mechanical,Electronics Engineering"
        
    else: 
        pred = "Choose Civil engineering"
    output = pred
